...
| AV5-012 | P2 | S | ⏸️ Deferred / not started | Backlog schema lint extension for AV5 IDs | docs validation enforces AV5 ticket row format (id/priority/effort/DoD/test/PR split) | docs schema lint test + negative cases | 1 PR |
